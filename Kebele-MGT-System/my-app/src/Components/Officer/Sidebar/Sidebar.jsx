    ...
    <div className='sidebar'>
      ...
      <div className="center">
        <ul>
          ...
          <Link to="/officer/users" style={{textDecoration: "none"}}>
          <li><PeopleOutlineIcon/><span>Users</span></li>
          </Link>
          <Link to="/officer/deactivate" style={{textDecoration: "none"}}>
          <li><ProductionQuantityLimitsIcon/><span>DeActivate</span></li>
          </Link>
          <Link to="/officer/activate" style={{textDecoration: "none"}}>
          ...
          <li><SystemSecurityUpdateGoodOutlinedIcon/><span>Membership </span></li>
          <li><PsychologyOutlinedIcon/><span>ID</span></li>
          <li><SettingsOutlinedIcon/><span>Certeficate</span></li>
          <li><SettingsOutlinedIcon/><span>Clearance</span></li>
          <li><SettingsOutlinedIcon/><span>Oil and Sugar</span></li>
