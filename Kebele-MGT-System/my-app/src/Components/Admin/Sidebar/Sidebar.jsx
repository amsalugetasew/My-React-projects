    ...
    <div className='sidebar'>
      ...
      <div className="center">
        <ul>
          ...
          <Link to="/admin/families" style={{textDecoration: "none"}}>
          <li><PeopleOutlineIcon/><span>Membership</span></li>
          </Link>


          <Link to="/admin/ID/Request" style={{textDecoration: "none"}}>
          <li><ProductionQuantityLimitsIcon/><span>ID Request</span></li>
          </Link>
          <Link to="/admin/BirthCerteficate/Request" style={{textDecoration: "none"}}>
          <li><ProductionQuantityLimitsIcon/><span>BIRTH CERTEFICATE Request</span></li>
          </Link>



          <Link to="/admin/Clearance/Request" style={{textDecoration: "none"}}>
          <li><PaymentIcon/><span>Clearance Request</span></li>
          </Link>
          <Link to="/admin/OilandSugar/Request" style={{textDecoration: "none"}}>
