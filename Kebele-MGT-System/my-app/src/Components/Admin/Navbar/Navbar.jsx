              ...
              <div className="DropDownContainer">
                ...
                <div className="DropDownListContainer">
                  <div className="DropDownList">
                    <div className="ListItem" onClick={handleChangephoto}><PersonAddAltOutlinedIcon/>
                    Profile
                    </div>
                    ...
                    <li className="ListItem" onClick={handleLogout}><LogoutOutlinedIcon/><span>Logout</span></li>
