...
const ClearanceNew = ({ inputs, title, users }) => {
    ...
    const handleAdd = async (e) => {
        ...
        try {
            ...
            await setDoc(doc(db, "IDClearance", res.user.uid), {
                ...data,
                timeStamp: serverTimestamp(),
            });
            // navigate(-1);
            navigate("/admin/Clearance/Request");
        }
        catch (errors) {
            console.log(errors)
        }
                ...
                <div className="bottom">
                    ...
                    <div className="right">
                        <form onSubmit={handleAdd}>
                            ...
                            <button disabled={per !== null && per < 100} type="submit">CLEARANCE REQUEST</button>
                        </form>
                    </div>
                </div>
            </div>
